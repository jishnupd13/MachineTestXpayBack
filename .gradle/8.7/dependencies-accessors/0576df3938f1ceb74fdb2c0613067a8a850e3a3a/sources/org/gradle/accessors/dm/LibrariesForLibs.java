...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class CircleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>image</b> with <b>de.hdodenhof:circleimageview</b> coordinates and
         * with version reference <b>circle.image.view</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.circle</b>
         */
    ...
    public static class CircleVersionAccessors extends VersionFactory  {
        ...
        private final CircleImageVersionAccessors vaccForCircleImageVersionAccessors = new CircleImageVersionAccessors(providers, config);
        public CircleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.circle.image</b>
         */
        public CircleImageVersionAccessors getImage() {
            return vaccForCircleImageVersionAccessors;
        }

    }

    public static class CircleImageVersionAccessors extends VersionFactory  {

        public CircleImageVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>circle.image.view</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getView() { return getVersion("circle.image.view"); }
